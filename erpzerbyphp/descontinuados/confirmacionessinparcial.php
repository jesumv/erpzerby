...
//esta version no tiene las celdas para mostrar entregas parciales.
...
//Y se crean dos columnas por cada orden empezando en 5
...
// continuacion del ciclo de  2 columnas 
            $colact = $colact +2;
...
//condicion para los valores de la tabla resumen
$itotal = 0;
$ctotal = 0;
$ptotal = 0;
$vtotal = 0;
...
<!--tabla 2 -->
 ...
 <?php
        for ($i=0;$i<$colord;$i++){
            echo "<td><input type=\"checkbox\" class = \"cincluye\" name=\"check$i\"
 ...
 ?>
  ...
  <?php
        for ($i=0;$i<$colord;$i++){
            echo "<td><input type=\"text\" class=\"TCMask[##/##/####]\" value=\"mm/dd/yyyy\"name=\"fecha$i\"
                 id=\"fecha$i\" '/> </td>";
        }
 ...
 ?>
  ...
  <?php
        for ($i=0;$i<$colord;$i++){
            echo "<td><input type=\"text\" class=\"TCMask[##:##]\" value=\"HH/MM\" name=\"hora$i\"
                 id=\"hora$i\" '/> </td>";
        }
 ...
 ?>
  ...
  <?php
        for ($i=0;$i<$colord;$i++){
            echo "<td><input type=\"text\" class='cincluye' name=\"noc$i\"
                 id=\"noc$i\" '/> </td>";
        }
 ...
 ?>
  ...
  <?php
        for ($i=0;$i<$colord;$i++){
            echo "<td><input type=\"text\" class='cincluye' name=\"conf$i\"
                 id=\"conf$i\" '/> </td>";
        }
 ...
 ?>
   ...
   <?php
            for ($i=0;$i<$colord;$i++){
            echo "<td> <textarea rows = \"4\" cols = \"15\" name=\"obs$i\"
...
//contador del numero de renglon COLUMNA 0
    ...
    // el numero del renglon                
                   ...
                   //upc y descripcion   
                    ...
                    //cantidad, cajas por cada renglon
                    for($k=5;$k<$colact;$k++){
