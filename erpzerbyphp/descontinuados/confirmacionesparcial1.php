...
//esta version ya muestra los datos para entrega parcial, pero no tiene la tabla oculta de datos para el calculo
...
//fila de importe 1
                echo "<tr id='importerow'>";
                    ...
                    for ($i = 0; $i<$colord; $i++){
                        ...
                        echo "<td class = 'imptot' class='cifr' id='impor$i'>$imporact </td>";
                    }
                ...
                echo "<tr id='impornumrow' style='display:none'>";
                    ...
                    for ($i = 0; $i<$colord; $i++){
                       $impornum = round($importes[$i], 2);
                        echo "<td class = 'imptot' id='impor2$i'>$impornum </td>";
                    }
