<?php
//esta hoja se usa para registrar salidas de almacen para entrega a wal-mart desde zerby
...
//directiva de conexion a hoja de funciones alta de salida
include_once"php/auxsalewm.php";
...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en" lang="en">
    ...
    <body>
        ...
        <?php 
              $titulo = "SALIDA DE ORDEN DE COMPRA WAL-MART";
 ...
 <!--construcción del combo de eleccion de producto---------------------------------------------------------------------->
        <div id ="cajacent">
                ...
                <form id= "traspaso"  method="post">
                    ...
                    <br />
                    Orden de Compra:<input type='text' name='orden'/>
                    <br />
                    <br />
                ...
                //ciclo para insertar una celda por cada campo y registro de la consulta SQL
                   ...
                   //celdas de informacion              
                    ...
                    <br />
                <div align= "center"><input type="submit" name = 'envios' value ='Registrar Salida'/></div>
